...
def solution(A):
    ...
    for i in range(aLen):
        if i == 0 : 
            ...
            R_list[i] = A[i] + max(R_list[i-1], R_list[i-2])
        elif i == 3:
            R_list[i] = A[i] + max(R_list[i-1], R_list[i-2], R_list[i-3])
        elif i == 4:
            R_list[i] = A[i] + max(R_list[i-1], R_list[i-2], R_list[i-3], R_list[i-4])
        elif i== 5:
            R_list[i] = A[i] + max(R_list[i-1], R_list[i-2], R_list[i-3], R_list[i-4], R_list[i-5])
        else : # i >= 6
            R_list[i] = A[i] + max(R_list[i-1], R_list[i-2], R_list[i-3], R_list[i-4], R_list[i-5], R_list[i-6])

    return R_list[aLen-1]
